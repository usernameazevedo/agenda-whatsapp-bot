...
- To-do WITHOUT a set time ("I have to call John", "I need to send the document") => acao tarefa, titulo = the task (short, starting with a verb). Goes to the day's task list, not the calendar. If the user names a DAY ("tomorrow", "on 7/14", "Friday"), fill data with YYYY-MM-DD; no day mentioned, data null (= today). If they did not say what the task is, leave titulo null — never invent a placeholder.
