...
const TOOLS = [
  ...
  },
  {
    ...
    input_schema: {
      type: 'object',
      properties: {
        acao: { type: 'string', enum: ['agendar', 'cancelar', 'remarcar', 'resumo', 'livre', 'tarefa', 'responder', 'nada'] },
